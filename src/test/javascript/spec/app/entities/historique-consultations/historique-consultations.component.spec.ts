...
import { HistoriqueConsultationsComponent } from 'app/entities/historique-consultations/historique-consultations.component';
...
describe('Component Tests', () => {
  describe('HistoriqueConsultations Management Component', () => {
    let comp: HistoriqueConsultationsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(HistoriqueConsultationsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new HistoriqueConsultations(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.historiqueConsultations && comp.historiqueConsultations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
