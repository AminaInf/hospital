...
describe('Component Tests', () => {
  describe('Antecedents Management Component', () => {
    let comp: AntecedentsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AntecedentsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.antecedents && comp.antecedents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
